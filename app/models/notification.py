...
class NotificationPreference(Base):
    ...
    booking_confirmations: Mapped[bool] = mapped_column(
        Boolean, default=True, nullable=False
    )
    booking_cancellations: Mapped[bool] = mapped_column(
        Boolean, default=True, nullable=False
    )
    event_reminders: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    waitlist_notifications: Mapped[bool] = mapped_column(
        Boolean, default=True, nullable=False
    )
    ...
    system_announcements: Mapped[bool] = mapped_column(
        Boolean, default=True, nullable=False
    )
    ...
    quiet_hours_start: Mapped[Optional[str]] = mapped_column(
        String(5), default="22:00", nullable=True
    )
    quiet_hours_end: Mapped[Optional[str]] = mapped_column(
        String(5), default="08:00", nullable=True
    )
